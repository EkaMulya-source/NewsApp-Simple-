...
class DetailWall extends StatefulWidget {

  final Map<String, dynamic> article;

  DetailWall({required this.article});

  @override
  State<DetailWall> createState() => _DetailWallState();
}

class _DetailWallState extends State<DetailWall> {
  @override
...
class NewsDetailWall extends StatelessWidget {
  
  final NewsArticleWall article;

  const NewsDetailWall({required this.article});
