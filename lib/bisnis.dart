...
class MyWidgetBisnis extends StatefulWidget {
  const MyWidgetBisnis({super.key});

  @override
  State<MyWidgetBisnis> createState() => _MyWidgetBisnisState();
}

class _MyWidgetBisnisState extends State<MyWidgetBisnis> {

  List<NewsArticleBisnis> newsList = [];
