...
class DetailBussines extends StatefulWidget {
  ...
  DetailBussines({required this.article});

  @override
  State<DetailBussines> createState() => _DetailBussinesState();
}

class _DetailBussinesState extends State<DetailBussines> {
  @override
...
class NewsDetailBussines extends StatelessWidget {
  
  final NewsArticleBisnis article;

  const NewsDetailBussines({required this.article});
